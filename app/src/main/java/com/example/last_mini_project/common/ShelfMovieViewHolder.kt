...
class ShelfMovieViewHolder(
    ...
    fun bindCategory(category: Category) {
        ...
        shelfBinding.childrenRecyclerView.layoutManager = LinearLayoutManager(itemView.context, LinearLayoutManager.HORIZONTAL,false)
        shelfBinding.childrenRecyclerView.adapter = MovieAdapter(category.movieShelf)
    }
}